...
from ozi_build.jwt.algorithms import HMACAlgorithm
from ozi_build.jwt.algorithms import NoneAlgorithm
from ozi_build.jwt.algorithms import has_crypto
from ozi_build.jwt.exceptions import InvalidKeyError
from ozi_build.jwt.utils import base64url_decode
...
if has_crypto:
    ...
    from ozi_build.jwt.algorithms import RSAPSSAlgorithm
...
class TestAlgorithms:
    ...
    def test_ec_verify_should_return_false_if_signature_invalid(self):
        ...
        sig = base64.b64decode(
            ...
            b"LZS5kbvKu0Acd/K6Ol2/W3B1NeV5F/gjvZn/jOwaLgWEUYsg0o4XVrAg65".replace(b"r", b"s")
        )
